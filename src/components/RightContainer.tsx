...
function RightContainer() {
  return (
    <section className="mx-auto md:ms-[30px] mt-[30px] max-w-[85%] md:max-w-[290px] font-sans text-neu-darkgrayishblue">
      ...
      <div className="text-base md:max-w-[87.5%] tracking-wide my-6">
        <p>
      ...
      <div className="flex mb-8 font-serif gap-x-4">
